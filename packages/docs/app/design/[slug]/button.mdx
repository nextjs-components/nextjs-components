import { Button, Container, Spacer, Text } from "nextjs-components";
...
{/* prettier-ignore */}
<Text as="h2" color="geist-secondary" size={20} weight={400} style={{margin: "revert"}}>Used to trigger an operation.</Text>
